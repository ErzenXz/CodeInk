export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i CodeInk është shkarkuar, dëshironi ta instaloni dhe rinisni?",
