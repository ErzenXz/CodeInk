export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace CodeInk. Chcete ji nainstalovat a aplikaci znovu spustit?",
