export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av CodeInk er lastet ned. Vil du installere den og starte på nytt?",
