export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av CodeInk har laddats ned. Vill du installera den och starta om programmet?",
