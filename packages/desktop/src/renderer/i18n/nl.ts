export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van CodeInk is gedownload. Wil je deze installeren en CodeInk opnieuw starten?",
