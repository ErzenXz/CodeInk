export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of CodeInk has been downloaded, would you like to install it and relaunch?",
