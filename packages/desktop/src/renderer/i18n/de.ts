export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von CodeInk wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
