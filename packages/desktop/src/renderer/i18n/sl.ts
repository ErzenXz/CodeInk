export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} CodeInk je bila prenesena, jo želite namestiti in znova zagnati?",
