export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju CodeInk-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} CodeInk-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
