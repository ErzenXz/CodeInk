export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af CodeInk er blevet downloadet. Vil du installere den og genstarte?",
