export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di CodeInk è stata scaricata. Vuoi installarla e riavviare l'app?",
