export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} CodeInk a fost descărcată. Vrei să o instalezi și să repornești?",
