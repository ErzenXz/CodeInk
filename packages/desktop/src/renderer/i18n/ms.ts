export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} CodeInk telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
