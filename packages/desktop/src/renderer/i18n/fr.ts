export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'CodeInk",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'CodeInk a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
