...
/**
 * Packaged Electron windows load renderer HTML via the privileged `codeink://`
...
describe("electron vite publicDir", () => {
  test("configured publicDir resolves to a directory with codeink-theme-preload.js", async () => {
    ...
    expect(existsSync(join(resolved, "codeink-theme-preload.js"))).toBe(true)
  })
})
