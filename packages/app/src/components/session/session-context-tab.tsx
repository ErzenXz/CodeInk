...
import { findLast } from "@codeink/core/util/array"
...
import { Markdown } from "@codeink/session-ui/markdown"
import { ScrollView } from "@codeink/ui/scroll-view"
import type { Message, Part, UserMessage } from "@codeink/sdk/v2/client"
...
export function SessionContextTab() {
  ...
  const cost = createMemo(() => {
    const value = getSessionCost(info())
  ...
  const stats = [
    ...
    { label: "context.stats.lastActivity", value: () => formatter().time(info()?.time.updated) },
