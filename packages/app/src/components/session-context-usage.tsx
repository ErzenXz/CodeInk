...
import { ProgressCircle } from "@codeink/ui/progress-circle"
import { ProgressCircleV2 } from "@codeink/ui/v2/progress-circle-v2"
  ...
  const tooltipValue = () => (
    <div class="flex w-[120px] flex-col gap-2">
      ...
      <ContextTooltipRow
        ...
        value={context()?.usage == null ? "—" : `${context()?.usage}%`}
      />
      <ContextTooltipRow
