import { compareModels, ModelLabel } from "./model-presentation"
import { Dialog } from "@codeink/ui/dialog"
import { List } from "@codeink/ui/list"
...
import { Dialog as DialogV2, DialogBody, DialogHeader, DialogTitleGroup } from "@codeink/ui/v2/dialog-v2"
...
import { Switch as SwitchV2 } from "@codeink/ui/v2/switch-v2"
                    ...
                    <div class="settings-v2-section" data-component="settings-models-provider">
                      ...
                      <SettingsListV2>
                        <For each={group.items}>
                          {(item) => (
                            <SettingsRowV2 title={<ModelLabel model={item} />} description="">
                              <div>
                                <SwitchV2
