...
beforeAll(async () => {
  ...
  mock.module("@codeink/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codeink/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codeink/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codeink/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
