...
import { getDirectory, getFilename, getFilenameTruncated } from "@codeink/core/util/path"
          ...
          {(item) => {
            ...
            return (
              ...
              >
                <div
                  classList={{
                    "group shrink-0 flex flex-col rounded-md pl-2 pr-1 py-1 max-w-[200px] h-12 cursor-pointer transition-all transition-transform shadow-xs-border hover:shadow-xs-border-hover": true,
