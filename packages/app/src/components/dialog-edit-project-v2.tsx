...
import { Field } from "@codeink/ui/v2/field-v2"
import { Icon } from "@codeink/ui/v2/icon"
import { ProjectAvatar, PROJECT_AVATAR_VARIANTS } from "@codeink/ui/v2/project-avatar-v2"
import { TextareaV2 } from "@codeink/ui/v2/textarea-v2"
                ...
                <For each={PROJECT_AVATAR_VARIANTS}>
                  {(color) => (
                    <button
                      ...
                      class="flex size-8 items-center justify-center rounded-xl p-1 outline outline-1 outline-transparent transition-[background-color,outline-color] hover:bg-v2-overlay-simple-overlay-hover focus-visible:outline-v2-border-border-focus"
                      classList={{
