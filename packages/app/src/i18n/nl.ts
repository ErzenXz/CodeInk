export const dict = {
  ...
  "desktop.menu.documentation": "CodeInk-documentatie",
  ...
  "desktop.recovery.loadFailed": "CodeInk kan niet worden geladen",
  "desktop.recovery.terminated": "Het CodeInk-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "CodeInk reageert niet",
  ...
  "desktop.wsl.error.updateVersion":
    "De CodeInk-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in CodeInk te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in CodeInk te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in CodeInk te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke CodeInk-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat CodeInk een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "CodeInk kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens CodeInk opnieuw.",
  ...
  "help.tabs.introduction": "CodeInk Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van CodeInk ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het CodeInk-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: CodeInk ondersteunt nog geen MCP-authenticatie.',
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor CodeInk",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe CodeInk eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of CodeInk het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van CodeInk aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer CodeInk wordt gestart",
  ...
  "settings.updates.toast.latest.title": "CodeInk is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van CodeInk.",
