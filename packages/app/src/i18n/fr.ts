export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'CodeInk",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'CodeInk",
  "desktop.recovery.terminated": "La fenêtre CodeInk s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "CodeInk ne répond pas",
  ...
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'CodeInk est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans CodeInk.",
  ...
  "dialog.server.description": "Changez le serveur CodeInk auquel cette application se connecte.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'CodeInk puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "CodeInk n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'CodeInk ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe CodeInk",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CodeInk ne prend pas encore en charge l'authentification MCP.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour CodeInk",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'CodeInk sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si CodeInk suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'CodeInk.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CodeInk",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CodeInk.",
