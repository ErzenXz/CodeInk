export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeInk yüklənə bilmədi",
  "desktop.recovery.terminated": "CodeInk pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "CodeInk cavab vermir",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInk yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və CodeInk-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və CodeInk-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və CodeInk-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu CodeInk serverini dəyişdirin.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodeInk WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "CodeInk bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra CodeInk-u yenidən açın.",
  ...
  "help.tabs.introduction": "CodeInk Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeInk-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı CodeInk komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: CodeInk hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "settings.general.row.language.description": "CodeInk üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "CodeInk-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description": "CodeInk-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "CodeInk-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "CodeInk açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "CodeInk-un ən son versiyasından istifadə edirsiniz.",
