export const dict = {
  ...
  "desktop.menu.ariaLabel": "CodeInk-meny",
  ...
  "desktop.recovery.loadFailed": "CodeInk kunde inte läsas in",
  "desktop.recovery.terminated": "CodeInk-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "CodeInk svarar inte",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInk-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i CodeInk.",
  ...
  "dialog.server.description": "Växla vilken CodeInk-server som denna app ansluter till.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan CodeInk kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "CodeInk kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan CodeInk igen.",
  ...
  "help.tabs.introduction": "CodeInk Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av CodeInk ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till CodeInk-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, CodeInk stöder inte MCP-autentisering ännu.',
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för CodeInk",
  ...
  "settings.general.row.appearance.description": "Anpassa hur CodeInk ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om CodeInk följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa CodeInks tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när CodeInk startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av CodeInk.",
