export const dict = {
  ...
  "desktop.menu.documentation": "Documentație CodeInk",
  ...
  "desktop.menu.ariaLabel": "Meniu CodeInk",
  ...
  "desktop.recovery.loadFailed": "CodeInk nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra CodeInk s-a închis neașteptat",
  "desktop.recovery.unresponsive": "CodeInk nu răspunde",
  ...
  "desktop.wsl.error.updateVersion":
    "Actualizarea CodeInk s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în CodeInk.",
  ...
  "dialog.server.description": "Schimbă serverul CodeInk la care se conectează aplicația.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca CodeInk să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "CodeInk nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune CodeInk ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei CodeInk",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, CodeInk nu suportă încă autentificarea MCP.',
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru CodeInk",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul CodeInk pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă CodeInk urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema CodeInk.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea CodeInk",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune CodeInk.",
