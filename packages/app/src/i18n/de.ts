...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CodeInk zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in CodeInk zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CodeInk zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den CodeInk-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor CodeInk einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "CodeInk konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann CodeInk erneut.",
  ...
  "toast.update.description": "Eine neue Version von CodeInk ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem CodeInk-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: CodeInk unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "CodeInk mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für CodeInk ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie CodeInk auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob CodeInk dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von CodeInk anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CodeInk automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "CodeInk ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von CodeInk wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "CodeInk konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das CodeInk-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "CodeInk reagiert nicht",
  ...
  "desktop.wsl.error.updateVersion":
    "Das CodeInk-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "CodeInk Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
