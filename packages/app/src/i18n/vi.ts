export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu CodeInk",
  ...
  "desktop.recovery.loadFailed": "Không tải được CodeInk",
  "desktop.recovery.terminated": "Cửa sổ CodeInk đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "CodeInk không phản hồi",
  ...
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật CodeInk nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong CodeInk.",
  ...
  "dialog.server.description": "Chuyển máy chủ CodeInk mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi CodeInk có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "CodeInk không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của CodeInk ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm CodeInk",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: CodeInk chưa hỗ trợ xác thực MCP.',
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho CodeInk",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của CodeInk trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem CodeInk tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của CodeInk.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi CodeInk khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của CodeInk.",
