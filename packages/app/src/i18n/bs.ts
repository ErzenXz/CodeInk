export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za CodeInk",
  ...
  "desktop.recovery.loadFailed": "CodeInk se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor CodeInk-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "CodeInk ne reaguje",
  ...
  "desktop.wsl.error.updateVersion":
    "Ažuriranje CodeInk-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CodeInk-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CodeInk-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CodeInk-u.",
  ...
  "dialog.server.description": "Promijeni na koji se CodeInk server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi CodeInk mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "CodeInk nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija CodeInk-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CodeInk timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CodeInk još ne podržava MCP autentifikaciju.',
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CodeInk-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako CodeInk izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CodeInk prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CodeInk-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CodeInk pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CodeInk-a.",
