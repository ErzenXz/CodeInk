export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in CodeInk.",
  ...
  "dialog.server.description": "Cambia il server CodeInk a cui si connette l'app.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che CodeInk possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "CodeInk non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired": "Riavvia Windows per completare l'installazione WSL, quindi riapri CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di CodeInk ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team CodeInk",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: CodeInk non supporta ancora l\'autenticazione MCP.',
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per CodeInk",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di CodeInk sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se CodeInk segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di CodeInk.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di CodeInk",
  ...
  "settings.updates.toast.latest.title": "CodeInk è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di CodeInk.",
  ...
  "desktop.menu.documentation": "Documentazione di CodeInk",
  ...
  "desktop.menu.ariaLabel": "Menu CodeInk",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare CodeInk",
  "desktop.recovery.terminated": "La finestra di CodeInk si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "CodeInk non risponde",
  ...
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di CodeInk è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
