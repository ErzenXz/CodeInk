export const dict = {
  ...
  "desktop.menu.documentation": "CodeInk Documentació",
  ...
  "desktop.menu.ariaLabel": "menú CodeInk.",
  ...
  "desktop.recovery.loadFailed": "CodeInk no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra CodeInk s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "CodeInk no respon",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInk actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a CodeInk.",
  ...
  "dialog.server.description": "Canvia a quin CodeInk servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que CodeInk pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CodeInk no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de CodeInk ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip CodeInk.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que CodeInk encara no admet l\'autenticació MCP.',
  ...
  "app.name.desktop": "CodeInk Escriptori",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a CodeInk",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu CodeInk al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si CodeInk segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de CodeInk.",
  ...
  "settings.updates.row.startup.description": "Comprova automàticament si hi ha actualitzacions quan s'iniciï CodeInk.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de CodeInk.",
