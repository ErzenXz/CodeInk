export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CodeInkssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja CodeInkssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CodeInkssa.",
  ...
  "dialog.server.description": "Vaihda CodeInk-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin CodeInk voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "CodeInk ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten CodeInk uudelleen.",
  ...
  "toast.update.description": "CodeInkn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä CodeInk-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että CodeInk ei vielä tue MCP-todennusta.',
  ...
  "settings.general.row.language.description": "Vaihda CodeInkn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä CodeInk näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö CodeInk järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta CodeInkn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun CodeInk käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät CodeInkn uusinta versiota.",
  ...
  "desktop.menu.documentation": "CodeInk-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "CodeInk-valikko",
  ...
  "desktop.recovery.loadFailed": "CodeInkn lataaminen epäonnistui",
  "desktop.recovery.terminated": "CodeInk-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "CodeInk ei vastaa",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInkn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "CodeInk Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
