export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de CodeInk",
  ...
  "desktop.menu.ariaLabel": "Menú de CodeInk",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar CodeInk",
  "desktop.recovery.terminated": "La ventana de CodeInk se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "CodeInk no responde",
  ...
  "desktop.wsl.error.updateVersion":
    "La actualización de CodeInk finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CodeInk.",
  ...
  "dialog.server.description": "Cambiar el servidor de CodeInk al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que CodeInk pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CodeInk no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de CodeInk ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de CodeInk",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: CodeInk aún no admite la autenticación MCP.',
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CodeInk",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve CodeInk en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CodeInk sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CodeInk.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CodeInk",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CodeInk.",
