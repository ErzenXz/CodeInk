export const dict = {
  ...
  "desktop.menu.documentation": "CodeInk hujjatlari",
  ...
  "desktop.menu.ariaLabel": "CodeInk menyusi",
  ...
  "desktop.recovery.loadFailed": "CodeInk yuklanmadi",
  "desktop.recovery.terminated": "CodeInk oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "CodeInk javob bermayapti",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInk yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va CodeInk’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va CodeInk da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va CodeInk da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi CodeInk serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodeInk WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "CodeInk WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra CodeInk-ni qayta oching.",
  ...
  "help.tabs.introduction": "CodeInk Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeInk ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida CodeInk jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, CodeInk hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "settings.general.row.language.description": "CodeInk uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "CodeInk qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "CodeInk tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "CodeInk mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "CodeInk ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz CodeInk oxirgi versiyasini ishga tushiryapsiz.",
