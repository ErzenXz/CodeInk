...
export const dict = {
  ...
  "desktop.menu.documentation": "CodeInk-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "CodeInk kunne ikke lastes inn",
  "desktop.recovery.terminated": "CodeInk-vinduet ble uventet avsluttet",
  ...
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av CodeInk er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CodeInk.",
  ...
  "dialog.server.description": "Bytt hvilken CodeInk-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CodeInk ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CodeInk-teamet",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CodeInk",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CodeInk ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om CodeInk skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i CodeInk.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CodeInk starter",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før CodeInk kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "CodeInk kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter CodeInk på nytt.",
  ...
  "help.tabs.introduction": "CodeInk Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
