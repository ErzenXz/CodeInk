...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius CodeInk.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio CodeInk serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad CodeInk galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "CodeInk nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują CodeInk ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą CodeInk komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad CodeInk dar nepalaiko MCP autentifikavimo.",
  ...
  "app.name.desktop": "CodeInk darbalaukis",
  ...
  "settings.general.row.language.description": "Pakeiskite CodeInk ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip CodeInk atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar CodeInk seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite CodeInk temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas CodeInk",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią CodeInk versiją.",
