export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i CodeInk.",
  ...
  "dialog.server.description": "Skift hvilken CodeInk-server denne app forbinder til.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før CodeInk kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "CodeInk kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter CodeInk igen.",
  ...
  "toast.update.description": "En ny version af CodeInk ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CodeInk-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CodeInk understøtter ikke MCP-godkendelse endnu.',
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CodeInk",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan CodeInk ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om CodeInk skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas CodeInks tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CodeInk starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CodeInk.",
  ...
  "desktop.recovery.loadFailed": "CodeInk kunne ikke indlæses",
  "desktop.recovery.terminated": "CodeInk-vinduet blev uventet afsluttet",
  "desktop.recovery.unresponsive": "CodeInk svarer ikke",
  ...
  "desktop.wsl.error.updateVersion":
    "Opdateringen af CodeInk er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "CodeInk Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
