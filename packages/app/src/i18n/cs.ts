export const dict = {
  ...
  "desktop.menu.documentation": "CodeInk Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka CodeInk",
  ...
  "desktop.recovery.loadFailed": "CodeInk se nepodařilo načíst",
  "desktop.recovery.terminated": "CodeInk okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "CodeInk nereaguje",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInk aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v CodeInk.",
  ...
  "dialog.server.description": "Přepněte, ke kterému CodeInk serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než CodeInk může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "CodeInk nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze CodeInk ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu CodeInk",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: CodeInk zatím nepodporuje ověřování MCP.',
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro CodeInk",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled CodeInk na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude CodeInk následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma CodeInk.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění CodeInk",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi CodeInk.",
