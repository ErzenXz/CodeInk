export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja CodeInk",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać CodeInk",
  "desktop.recovery.terminated": "Okno CodeInk zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "CodeInk nie odpowiada",
  ...
  "desktop.wsl.error.updateVersion":
    "Aktualizacja CodeInk została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CodeInk.",
  ...
  "dialog.server.description": "Przełącz serwer CodeInk, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim CodeInk będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "CodeInk nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja CodeInk ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CodeInk",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: CodeInk nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CodeInk",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd CodeInk na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CodeInk ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CodeInk.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CodeInk",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CodeInk.",
