...
export const dict = {
  ...
  "command.provider.connect": "Configure agent",
  ...
  "dialog.provider.viewAll": "Configure agents",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CodeInk.",
  "provider.connect.oauth.auto.confirmationCode": "Confirmation code",
  "provider.connect.toast.connected.title": "{{provider}} connected",
  "provider.connect.toast.connected.description": "{{provider}} models are now available to use.",

  "provider.custom.title": "Custom agent",
  ...
  "dialog.server.description": "Switch which CodeInk server this app connects to.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before CodeInk can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "CodeInk could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of CodeInk ({{version}}) is now available to install.",
  "toast.update.description.downloadPage": "A new version of CodeInk ({{version}}) is available on our download page.",
  "toast.update.action.installRestart": "Install and restart",
  "toast.update.action.viewDownload": "View downloads",
  ...
  "error.page.action.downloadVersion": "Download {{version}}",
  "error.page.circular": "[Circular]",
  "error.page.report.prefix": "Please report this error to the CodeInk team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CodeInk does not support MCP authentication yet.',
  ...
  "sidebar.brand": "CodeInk",
  "sidebar.sessions.newChat": "New chat",
  "sidebar.sessions.view.all": "All",
  "sidebar.sessions.view.activity": "Activity",
  "sidebar.sessions.status.active": "Active",
  "sidebar.sessions.status.attention": "Needs attention",
  "sidebar.sessions.sort.label": "Sort by",
  "sidebar.sessions.sort.updated": "Recent activity",
  "sidebar.sessions.sort.created": "Date created",
  "sidebar.sessions.sort.title": "Name",
  "sidebar.sessions.limit.label": "Chats per group",
  "sidebar.sessions.limit.all": "All",
  "sidebar.sessions.timestamps": "Show timestamps",
  "sidebar.sessions.expandAll": "Expand all",
  "sidebar.sessions.collapseAll": "Collapse all",
  "sidebar.projects.label": "Projects",
  "sidebar.projects.add": "Add project",
  "sidebar.sessions.view.label": "Session view",
  "sidebar.sessions.filters": "Session filters",
  "sidebar.sessions.group.label": "Group by",
  "sidebar.sessions.group.project": "Project",
  "sidebar.sessions.group.workspace": "Workspace",
  "sidebar.sessions.group.status": "Status",
  "sidebar.sessions.group.server": "Server",
  "sidebar.sessions.group.type": "Type",
  "sidebar.sessions.group.recent": "Recent",
  "sidebar.sessions.group.none": "None",
  "sidebar.sessions.group.unknownProject": "Other projects",
  "sidebar.sessions.group.unknownWorkspace": "Other workspaces",
  "sidebar.sessions.group.working": "Working",
  "sidebar.sessions.group.attention": "Needs attention",
  "sidebar.sessions.group.idle": "Idle",
  "sidebar.sessions.group.draft": "Drafts",
  "sidebar.sessions.group.session": "Sessions",
  "sidebar.sessions.activity.empty": "No active sessions",
  "sidebar.sessions.showMore": "Show more",
  "sidebar.sessions.showLess": "Show less",
  "sidebar.projects.showMore": "Show more projects",
  "sidebar.projects.showLess": "Show fewer projects",
  "sidebar.groups.showMore": "Show more groups",
  "sidebar.groups.showLess": "Show fewer groups",
  "sidebar.context.project.newChat": "New chat in project",
  "sidebar.context.project.copyPath": "Copy project path",
  "sidebar.context.project.close": "Close project",
  "sidebar.context.group.collapse": "Collapse",
  "sidebar.context.group.expand": "Expand",
  "sidebar.context.session.open": "Open chat",
  "sidebar.context.session.openDraft": "Open draft",
  "sidebar.context.session.openBackground": "Open in background",
  "sidebar.context.session.newChat": "New chat here",
  "sidebar.context.session.copyLink": "Copy local link",
  "sidebar.context.session.copyID": "Copy chat ID",
  "sidebar.context.session.renameTitle": "Rename chat",
  "sidebar.context.session.name": "Chat name",
  "sidebar.settings": "Settings",
  "sidebar.help": "Help",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "Connect an installed coding agent to get started.",
  ...
  "app.name.desktop": "CodeInk Desktop",
  ...
  "settings.general.row.language.description": "Change the display language for CodeInk",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CodeInk looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CodeInk follows the system, light, or dark theme",
  "settings.general.row.sessionTabs.title": "Session layout",
  "settings.general.row.sessionTabs.description": "Choose a project sidebar or top tabs",
  "settings.general.row.sessionTabs.top": "Top bar",
  "settings.general.row.sessionTabs.sidebar": "Sidebar",
  "settings.general.row.sessionTabs.projects": "Projects + tabs",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CodeInk is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CodeInk launches",
  ...
  "settings.updates.row.check.downloadDescription": "Check CodeInk releases and open the download page when an update is available",
  "settings.updates.action.checkNow": "Check now",
  "settings.updates.action.checking": "Checking...",
  "settings.updates.action.viewDownload": "View downloads",
  "settings.updates.action.downloading": "Downloading...",
  "settings.updates.action.installing": "Installing...",
  "settings.updates.toast.latest.title": "You're up to date",
  "settings.updates.toast.latest.description": "You're running the latest version of CodeInk.",
  ...
  "settings.providers.title": "Agents",
  "settings.providers.description": "Provider settings will be configurable here.",
  "settings.providers.section.connected": "Installed agents",
  "settings.providers.connected.empty": "No connected providers",
  "settings.providers.connected.environmentDescription": "Executable available on this computer",
  "settings.providers.section.popular": "Other agents",
  "settings.providers.custom.description": "Connect an executable using a supported agent protocol.",
  "settings.providers.tag.environment": "Local",
  ...
  "agents.description":
    "Choose an installed coding agent. Authentication stays in its CLI; nothing is bundled or downloaded.",
  "agents.executable": "Executable path",
  "agents.arguments": "Extra arguments (JSON array)",
  "agents.protocol": "Protocol",
  "agents.name": "Name",
  "agents.installed": "Available",
  "agents.missing": "Not found — install and sign in using the agent's CLI, or set its executable path below.",
  "agents.invalidArguments": "Extra arguments must be a JSON array of strings.",
  "agents.desktopOnly": "Installed agents are available in the desktop app.",
  "agents.add": "Add agent",
  "agents.custom": "Custom agent",

  "sidebar.nav.library": "Library",
  "sidebar.nav.skills": "Skills & Plugins",

  "hub.refresh": "Refresh",
  "hub.desktopOnly": "Available in the CodeInk desktop app.",
  "hub.loadFailed": "Couldn't load {{name}}: {{error}}",
  "hub.copyPath": "Copy path",
  "hub.allAgents": "All agents",

  "hub.library.title": "Library",
  "hub.library.description": "Every chat across your projects and agents.",
  "hub.library.search": "Search chats",
  "hub.library.allProjects": "All projects",
  "hub.library.today": "Today",
  "hub.library.yesterday": "Yesterday",
  "hub.library.week": "Previous 7 days",
  "hub.library.month": "Previous 30 days",
  "hub.library.older": "Older",
  "hub.library.empty": "No chats yet. Start one with New chat.",
  "hub.library.noResults": "No chats match your search.",

  "hub.skills.title": "Skills & Plugins",
  "hub.skills.description": "Skills, plugins, and MCP servers your agents can use.",
  "hub.skills.tab.skill": "Skills",
  "hub.skills.tab.plugin": "Plugins",
  "hub.skills.tab.mcp": "MCP servers",
  "hub.skills.search": "Search",
  "hub.skills.empty": "Nothing here for these agents.",
  "hub.skills.noAgents": "Install Codex or Claude Code to manage skills and plugins here.",
  "hub.skills.toggle": "Enable {{name}}",
  "hub.skills.readOnly": "Managed by the agent",
  "hub.skills.tools": "Tools: {{count}}",
  "hub.skills.scope.user": "Personal",
  "hub.skills.scope.system": "Built-in",
  "hub.skills.scope.repo": "Project",
  "hub.skills.scope.admin": "Organization",
  "hub.skills.off": "Off",
  "hub.skills.status.connected": "Connected",
  "hub.skills.status.starting": "Starting",
  "hub.skills.status.failed": "Failed",
  "hub.skills.status.authenticationRequired": "Sign-in required",
  "hub.skills.status.disabled": "Disabled",

  "settings.instructions.title": "Instructions",
  "settings.instructions.description": "Global instructions each agent reads at the start of every chat.",
  "settings.instructions.placeholder": "Write instructions in Markdown…",
  "settings.instructions.new": "This file doesn't exist yet. Saving creates it.",
  "settings.instructions.saved": "Instructions saved",
  "settings.instructions.unsaved": "Unsaved changes",
  "settings.instructions.discard": "Discard unsaved changes?",

  "settings.usage.title": "Usage",
  "settings.usage.description": "Plan limits and activity for each of your agents.",
  "settings.usage.window.session": "Current session",
  "settings.usage.window.weekly": "Weekly",
  "settings.usage.window.other": "Limit",
  "settings.usage.used": "{{percent}}% used",
  "settings.usage.resets": "Resets {{time}}",
  "settings.usage.live": "Live",
  "settings.usage.updated": "Updated {{time}}",
  "settings.usage.noLimits": "This agent doesn't report plan limits.",
  "settings.usage.stat.chats": "Chats",
  "settings.usage.stat.input": "Input tokens",
  "settings.usage.stat.output": "Output tokens",
  "settings.usage.stat.cost": "Cost",
  "settings.usage.stat.lastUsed": "Last used",
  "settings.usage.empty": "No agents found.",

  "prompt.access.label": "Agent access",
  "prompt.access.ask": "Ask for approval",
  "prompt.access.ask.description": "Asks before running commands or changing files",
  "prompt.access.edits": "Accept edits",
  "prompt.access.edits.description": "Edits files on its own; asks before other actions",
  "prompt.access.auto": "Auto review",
  "prompt.access.auto.description": "A reviewer model approves safe actions; risky ones still ask",
  "prompt.access.plan": "Plan only",
  "prompt.access.plan.description": "Reads and plans without changing anything",
  "prompt.access.full": "Full access",
  "prompt.access.full.description": "Runs anything without asking. Use only in a trusted, isolated workspace",
  "prompt.access.fast": "Fast mode",
  "prompt.access.fast.description": "Faster responses at a higher usage cost",
  "prompt.access.fastBadge": "Fast",
}
