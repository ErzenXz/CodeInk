export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل CodeInk",
  "desktop.recovery.terminated": "توقفت نافذة CodeInk بشكل غير متوقع",
  "desktop.recovery.unresponsive": "CodeInk لا يستجيب",
  ...
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث CodeInk، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في CodeInk.",
  ...
  "dialog.server.description": "تبديل خادم CodeInk الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن CodeInk من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على CodeInk التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح CodeInk.",
  ...
  "help.tabs.introduction": "أصبح CodeInk Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من CodeInk ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق CodeInk",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن CodeInk لا يدعم مصادقة MCP بعد.',
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ CodeInk",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور CodeInk على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان CodeInk يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة CodeInk.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل CodeInk",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من CodeInk.",
