...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.menu.documentation": "CodeInk Documentation",
  ...
  "desktop.updater.dialog.download": "View downloads",
  ...
  "desktop.recovery.loadFailed": "CodeInk failed to load",
  "desktop.recovery.terminated": "CodeInk window terminated unexpectedly",
  "desktop.recovery.unresponsive": "CodeInk is not responding",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInk update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
