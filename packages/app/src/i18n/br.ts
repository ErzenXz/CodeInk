export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do CodeInk",
  ...
  "desktop.menu.ariaLabel": "Menu do CodeInk",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o CodeInk",
  "desktop.recovery.terminated": "A janela do CodeInk foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O CodeInk não está respondendo",
  ...
  "desktop.wsl.error.updateVersion":
    "A atualização do CodeInk foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CodeInk.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CodeInk.",
  ...
  "dialog.server.description": "Trocar para qual servidor CodeInk este aplicativo se conecta.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o CodeInk possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O CodeInk não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o CodeInk novamente.",
  ...
  "help.tabs.introduction": "Agora, o CodeInk Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do CodeInk ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CodeInk",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CodeInk ainda não suporta autenticação MCP.',
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CodeInk",
  ...
  "settings.general.row.appearance.description": "Personalize como o CodeInk aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CodeInk segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CodeInk é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CodeInk iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CodeInk.",
