...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeInk 加载失败",
  "desktop.recovery.terminated": "CodeInk 窗口意外终止",
  "desktop.recovery.unresponsive": "CodeInk 未响应",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInk 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 CodeInk 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 CodeInk 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 CodeInk 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 CodeInk 服务器。",
  ...
  "wsl.onboarding.wslNotInstalled.description": "CodeInk 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "CodeInk 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 CodeInk。",
  ...
  "help.tabs.introduction": "CodeInk Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeInk 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 CodeInk 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：CodeInk 暂不支持 MCP 认证。',
  ...
  "settings.general.row.language.description": "更改 CodeInk 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 CodeInk 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 CodeInk 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 CodeInk 的主题。",
  ...
  "settings.updates.row.startup.description": "在 CodeInk 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 CodeInk。",
