export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeInk laadimine ebaõnnestus",
  "desktop.recovery.terminated": "CodeInk aken suleti ootamatult",
  "desktop.recovery.unresponsive": "CodeInk ei vasta",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInk värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid CodeInk'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises CodeInk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises CodeInk.",
  ...
  "dialog.server.description": "Lülitage, millise CodeInk serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui CodeInk saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "CodeInk ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti CodeInk.",
  ...
  "help.tabs.introduction": "CodeInk Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse CodeInk ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast CodeInk meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, CodeInk ei toeta veel MCP autentimist.',
  ...
  "app.name.desktop": "CodeInk Töölaud",
  ...
  "settings.general.row.language.description": "Muutke CodeInk kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas CodeInk teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas CodeInk järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas CodeInk on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui CodeInk käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse CodeInk uusimat versiooni.",
