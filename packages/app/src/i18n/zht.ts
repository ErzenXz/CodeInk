...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeInk 載入失敗",
  "desktop.recovery.terminated": "CodeInk 視窗意外終止",
  "desktop.recovery.unresponsive": "CodeInk 沒有回應",
  ...
  "desktop.wsl.error.updateVersion":
    "CodeInk 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 CodeInk 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 CodeInk 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 CodeInk 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 CodeInk 伺服器。",
  ...
  "wsl.onboarding.wslUnavailable.description": "CodeInk 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 CodeInk。",
  ...
  "help.tabs.introduction": "CodeInk Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeInk 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 CodeInk 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：CodeInk 尚不支援 MCP 驗證。",
  ...
  "settings.general.row.language.description": "變更 CodeInk 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 CodeInk 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 CodeInk 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 CodeInk 的主題。",
  ...
  "settings.updates.row.startup.description": "在 CodeInk 啟動時自動檢查更新",
