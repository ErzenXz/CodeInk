...
import { TooltipKeybind } from "@codeink/ui/tooltip"
import { ResizeHandle } from "@codeink/ui/resize-handle"
import { Mark } from "@codeink/ui/logo"
    ...
    <Show when={isDesktop() && !(settings.general.newLayoutDesigns() && !params.id)}>
      <aside
        ...
        classList={{
          ...
          "rounded-xl shadow-[var(--v2-elevation-raised)] overflow-hidden": settings.general.newLayoutDesigns(),
          "flex-1": reviewOpen(),
        }}
