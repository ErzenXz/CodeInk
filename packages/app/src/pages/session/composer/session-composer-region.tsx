    ...
    >
      <div
        classList={{
          ...
          "md:max-w-[768px] md:mx-auto": controller.centered(),
        }}
      >
            ...
            >
              ...
              >
                <div
                  ...
                  class="w-full rounded-xl border border-border-weak-base bg-background-base p-3 text-16-regular text-text-weak"
                >
