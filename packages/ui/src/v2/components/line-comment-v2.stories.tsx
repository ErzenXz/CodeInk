...
const docs = `### Overview
Line comment **display** and **editor** cards aligned with CodeInk's line-comment design (raised \`#FAFAFA\` surface, footer line context, \`ButtonV2\` neutral + contrast actions).
