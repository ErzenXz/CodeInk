...
import { registerCodeInkTheme } from "@codeink/ui/context/marked-theme-register"

registerCodeInkTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for CodeInk, as I think 8 might be
